...
{
static HWND hwndMin,hwndR,hwndG,hwndB,hwndY,hwndBl,hwndP,hwndPen,hwndErase,hwndClear,hwndClose,hwndCapture;
RECT rc;
static BOOL OnOff;
LPDRAWITEMSTRUCT pdis;
static HBRUSH hRed,hBlue,hGreen,hBlack,hYellow,hPink;
